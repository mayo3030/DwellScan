    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2"><Label>Agency Name</Label><Input placeholder="Agency" /></div>
          <div className="space-y-2"><Label>License Number</Label><Input placeholder="License #" /></div>
